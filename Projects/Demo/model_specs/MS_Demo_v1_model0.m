function [R p m uc] = MS_Demo_model0(R)
%% Revised Model Space %%
% Model 1.1
%% MODEL 1 %%%
m.m = 1; % # of sources
m.x = {[0 0 0 0 0 0 0 0]}; % Initial states
m.Gint = [14]; % number of gain parameters
m.Tint = [4]; % number of time constant parameters
m.Sint = [9]; % number of transfer constants (for sigmoid)
...
% Define the states that are passed to the observer function
