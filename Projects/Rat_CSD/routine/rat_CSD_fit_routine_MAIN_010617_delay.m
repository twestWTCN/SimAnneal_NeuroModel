...
[F_data,meancsd_data] = constructCSDMat(data,R.chloc_name,ftdata.label',fsamp,R.obs.csd.pow2_exp,R);
...
load('C:\Users\twest\Documents\Work\PhD\LitvakProject\Bernadette_DCM\outputs\splitup_BGM\onerat_bgm_DCM_multipass_split_finished','DCM')
clear u
