...
m.fxord = DCM.Sname;
m.Bmod = DCM.B;
load('C:\Users\twest\Documents\Work\PhD\LitvakProject\SimAnneal_NeuroModel\Projects\Rat_CSD\outputs\inverted_cross_250517','xobs')

%  p = xobs.out.P;
[xobs] = SimAn_170517(x,u,p,m,R);


xsim = stepintegrator(R,x,u,m,xobs.out.P);

[xsimob R] = observe_data(xsim,m,xobs.out.P,R);
