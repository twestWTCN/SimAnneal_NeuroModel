% THIS IS THE STN/GPE Model Comp
...
%% Prepare Model
[R p m uc] = MS_rat_STN_GPe_ModelComp_Model1(R);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
R.out.dag = 'NPD_STN_GPe_ModComp_M1'; % 'All Cross'
R.out.tag = 'ModComp';
R.plot.save = 'False';
R.obs.logdetrend =1;

R.SimAn.starttemp = 2;
R.SimAn.rep =32; %512; %96; %512; % Repeats per temperature
R.SimAn.Tm = 1;
R.SimAn.jitter = 1;
R.SimAn.searchN = 200;
R = setSimTime(R,18);
