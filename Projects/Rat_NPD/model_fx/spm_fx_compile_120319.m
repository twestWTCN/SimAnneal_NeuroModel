...
for condsel = 1:numel(R.condnames)
    ...
    E(5,:) = [.2 .2 -.2 -.2]*3000;             % STR connections
    E(6,:) = [.2 .2 -.2 -.2]*3000;             % GPE connections
    E(7,:) = [.2 .2 -.2 -.2]*3000;             % STN connections
    E(8,:) = [.2 .2 -.2 -.2]*3000;             % GPI connections
    E(9,:) = [.2 .2 -.2 -.2]*1500;  %500       % THAL connections
