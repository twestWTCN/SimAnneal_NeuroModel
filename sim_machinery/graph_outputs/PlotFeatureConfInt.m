...
for i = 1:N
    for j = 1:M
        ...
        [hl, hp] =boundedline(F,Y,B,'cmap',cmap);
        hl(1).LineWidth = 1; hl(2).LineWidth = 1; hl(3).LineWidth = 1;
...
saveallfiguresFIL_n([R.rootn '\outputs\' R.out.tag '\featConf'],'-jpg',1,'-r200',1);